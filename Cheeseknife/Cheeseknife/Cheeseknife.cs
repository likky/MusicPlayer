...
namespace Com.Lilarcor.Cheeseknife
{
	...
	public class BaseInjectionAttribute : Attribute {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.BaseInjectionAttribute"/> class.
		/// </summary>
	...
	public class InjectView : BaseInjectionAttribute {	
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectView"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnClick : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnClick"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnCheckedChange : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnCheckedChange"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnEditorAction : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnEditorAction"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnFocusChange : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnFocusChange"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnItemClick : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnItemClick"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnItemLongClick : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnItemLongClick"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnLongClick : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnLongClick"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnTouch : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnTouch"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
	...
	public class InjectOnTextChanged : BaseInjectionAttribute {
		/// <summary>
		/// Initializes a new instance of the <see cref="Com.Lilarcor.Cheeseknife.InjectOnTextChanged"/> class.
		/// </summary>
		/// <param name="resourceId">Resource identifier.</param>
